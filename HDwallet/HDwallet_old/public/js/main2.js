...
function generate_addresses(seed)//creating addresses by the seed (12 words )
{
	...
	if(!Number.isInteger(parseInt(totalAddresses)))//checking the input that was entered
	{
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
	    		ks.generateNewAddress(pwDerivedKey, totalAddresses);
	    		 addresses = ks.getAddresses();//getting the adresses in array from the keystore	
					
	    		var web3 = new Web3(new Web3.providers.HttpProvider('https://Kovan.infura.io/v3/3fb8dd7c991d45ada6420c1b4280a121'));//using rinkbey!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	    		var html = "";
	    		...
	    		for(var count = 0; count < addresses.length; count++)//for each adress in the addresses
	    		{
					...
					html = html + "<p><b>Balance: </b>" + web3.fromWei(balance, "ether") + " DogeCoin</p>";//its balance
		    		html = html + "</li>";
	    		}
...
//
{
	...
	if(!lightwallet.keystore.isSeedValid(seed))//checking if the seed
	{
		document.getElementById("info").innerHTML = "Please enter a valid seed";
		return;
	}
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
			    ...
			    var provider = new HookedWeb3Provider({
  					host:'https://Kovan.infura.io/v3/3fb8dd7c991d45ada6420c1b4280a121',//here we choose infura/ganachi/or ropsten/rinkbey
