		...
		password: password,
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
	    		...
	    		var web3 = new Web3(new Web3.providers.HttpProvider('https://rinkeby.infura.io/v3/3fb8dd7c991d45ada6420c1b4280a121'));//using rinkbey!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	    		var html = "";
	    		...
	    		for(var count = 0; count < addresses.length; count++)//for each adress in the addresses
	    		{
					...
					html = html + "<p><b>Balance: </b>" + web3.fromWei(balance, "ether") + " C98</p>";//its balance
		    		html = html + "</li>";
	    		}
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
			    ...
			    var provider = new HookedWeb3Provider({
  					host:'https://rinkeby.infura.io/v3/3fb8dd7c991d45ada6420c1b4280a121',//here we choose infura/ganachi/or ropsten/rinkbey
